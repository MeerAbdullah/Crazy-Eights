 ...
 * @synopsis: The Card class creates one
 * card out of a stack of 52 to create a Deck of cards.
 * @version %i%
 */
public class Card implements Comparable<Card> {
	...
	/**
	 * @param - other Checks to see if 2 cards equal eachother
	 * @return boolean
	 */
	...
	/**
	 * @param - other Compares cards using Comparable<T> interface
	 * @return int
	 */
	...
	/**
	 * String representation of Card. return String;
	 */
	...
	/**
	 * String representation of Cards rank. return String;
	 */
