...
* Date: 4/13/2021
* Synopsis: The player class represents the player that is playing the game in CrazyEights.
*/
public class Player{
  private String name;
  private int id;
  ...
  /**
  * Player constructor that creates an attribute of a Player, and what they need to play CrazyEights.
  */
