...
* Date: 4/13/2021
* Synopsis: The Deck class creates a Deck of cards, including a pile, for user to utilize in their card game.
*/
public class Deck{
  
  /*
  * Static instance variables - each instance of deck has to have the same cards and values.
  */
  ...
  */
  ...
  /**
  * @param - number
  * Deals multiple cards out of the deck, and as it does this it removes those cards.
  * @return Card[]
  */
  ...
  */
  public static void shuffle(){
    ...
    Card[] arr = new Card[MAX_SIZE];
    while(card.size() > 0){
      Card card1 = card.remove(card.size() - 1);
